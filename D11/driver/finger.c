...
uint8_t cmd_timeout[] = {0x3a,0x01,0x10,0x00,0x00,0x00,0x00};
uint8_t cmd_set_finger_on_time[] = {0x3a,0x07,0x00,0x80,0x00,0x01,0x00,0x08};
...
void FINGER_timeout(void){
   cmd_pack(cmd_timeout);
}

void FINGER_set_finger_on_time(void){
   cmd_pack(cmd_set_finger_on_time);
}